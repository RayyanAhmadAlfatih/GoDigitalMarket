                        ...
                        <?php foreach ($proofs as $proof): ?>
                            ...
                            <article class="admin-proof-item">
                                ...
                                <div class="admin-proof-actions">
                                    <?php if ($fileUrl): ?><a class="admin-btn admin-btn--ghost" href="<?= esc($fileUrl); ?>" target="_blank" rel="noopener">Lihat Bukti</a><?php endif; ?>
                                    <?php if (!empty($proof['order_id'])): ?><a class="admin-btn admin-btn--ghost" href="<?= url('admin/orders?search=' . rawurlencode((string)($proof['order_ref'] ?? ''))); ?>">Buka Order</a><?php endif; ?>
